...
//Drag and Drop the 2 elements  one by one and see what happens
public class DragandDrop_24 {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		//WebElement drop3=driver.findElement(By.id("div1"));
		WebElement drop3=driver.findElement(By.xpath("(//div[@ondragover='allowDrop(event)'])[4]"));
